...
:closed_lock_with_key: :computer: A simple game that allows players to simple guess the password on a certain number of tries

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./guessthepassword1.png)
![Screenshot](./guessthepassword2.png)
